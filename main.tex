...
\solution
We know that from uniform random variable pdf:
 \begin{equation}
f(x) =  \left\{
        \begin{array}{lll}
            0& \quad x\leq0 \\
...
& =0\leq 1-U \leq 1
\\
& ={-\infty} \leq \ln(1-U) \leq 0
\\
& ={-\infty} \ leq 2\ln(1-U) \leq 0
\\
& =\infty\geq -2\ln(1-U)\geq 0
\\
& =0\geq 2\ln(1-U)\geq {\infty}
\end{align*}
For $u\in U, v\in V$
\begin{align*}
& V=-2\ln(1-U)
...
\end{align*}
\begin{equation}
F_V(v)=F_V(1-e^(\frac{-v}{2})
\end{equation}
 \begin{equation}
 F_V(x) =  \left\{
        \begin{array}{lll}
            1-e^(\frac{-x}{2})& \quad x\geq0 \\
             0& \quad x< 0
        \end{array}
    \right.
\end{equation}
